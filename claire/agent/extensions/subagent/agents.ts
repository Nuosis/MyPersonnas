...
export function discoverAgents(cwd: string, scope: AgentScope): AgentDiscoveryResult {
	const userDir = path.join(getAgentDir(), "workers");
 ...
 */
export function loadSkills(skillNames: string[], cwd: string): string {
	const skillParts: string[] = [];
	const skillDirs = [
		path.join(getAgentDir(), "..", "skills"),  // ~/.pi/agent/skills
		path.join(cwd, ".pi", "skills"),           // .pi/skills in project
	];
